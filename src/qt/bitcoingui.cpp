...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and banana_token: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a banana_token: URI or payment request"));
