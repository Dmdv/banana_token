...
const QString BITCOIN_IPC_PREFIX("banana_token:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/banana_token-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/banana_token-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/banana_token-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start banana_token: click-to-pay handler"));
        }
        else {
