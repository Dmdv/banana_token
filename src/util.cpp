...
const char * const BITCOIN_CONF_FILENAME = "banana_token.conf";
const char * const BITCOIN_PID_FILENAME = "banana_token.pid";
...
#else
    const char* pszModule = "banana_token";
#endif
    if (pex)
        return strprintf(
