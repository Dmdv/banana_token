...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.banana_token.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.banana_tokentools.com", true);
        vSeeds.emplace_back("dnsseed.banana_tokenpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.banana_tokentools.com", true);
        vSeeds.emplace_back("seed-b.banana_token.loshan.co.uk", true);
