...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s banana_token-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  banana_token-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded banana_token transaction") + "\n" +
              "  banana_token-tx [options] -create [commands]   " + _("Create hex-encoded banana_token transaction") + "\n" +
              "\n";
