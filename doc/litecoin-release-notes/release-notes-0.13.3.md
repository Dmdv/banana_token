Litecoin Core version 0.13.3 is now available from:
  ...
  <https://download.banana_token.org/banana_token-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/banana_token-project/banana_token/blob/0.13/src/chainparams.cpp#L214).
