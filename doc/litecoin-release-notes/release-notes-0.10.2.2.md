Litecoin Core version 0.10.2.2 is now available from:
  ...
  <https://download.banana_token.org/banana_token-0.10.2.2/>
...
banana_tokend/banana_token-qt (on Linux).
...
- banana_tokend no longer sends RPC commands.  You must use the separate banana_token-cli command line utility.
