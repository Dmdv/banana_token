...
This means one can have an always-on banana_tokend instance running, and another local banana_tokend/banana_token-qt instance which connects to this node and receives blocks from it.
