...
LITECOIND=${LITECOIND:-$SRCDIR/banana_tokend}
LITECOINCLI=${LITECOINCLI:-$SRCDIR/banana_token-cli}
LITECOINTX=${LITECOINTX:-$SRCDIR/banana_token-tx}
LITECOINQT=${LITECOINQT:-$SRCDIR/qt/banana_token-qt}
